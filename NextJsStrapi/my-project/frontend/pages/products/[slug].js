                ...
                <div className="container px-5 py-24 mx-auto">
                    <div className="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            <h2 className="text-sm title-font text-white-500 tracking-widest">MyShop</h2>
                            <h1 className="text-white-800 text-3xl title-font font-medium mb-1">{product.attributes.title}</h1>
                            ...
                            <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                ...
                                <div className="flex ml-6 items-center">
                                    ...
                                    <div className="relative">
                                        ...
                                        <span className="absolute right-0 top-0 h-full w-10 text-center text-white-800 pointer-events-none flex items-center justify-center">
                            ...
                            <div className="flex">
                                <span className="title-font font-medium text-2xl text-white-900"> ${product.attributes.price}</span>
                                ...
                                <button className="rounded-full w-10 h-10 bg-gray-200 p-0 border-0 inline-flex items-center justify-center text-white-700 ml-4">
                                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
...
export async function getServerSideProps(context) {
    ...
    const a = await fetch('http://127.0.0.1:1337/api/products?filters[Slug]=' + context.query.slug, { headers: headers })
